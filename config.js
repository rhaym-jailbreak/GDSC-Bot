module.exports = {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "1071141648169439314", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  EMBED_COLORS: {
    BOT_EMBED: "#068ADD",
    TRANSPARENT: "#36393F",
  ...
  PRESENCE: {
    ...
    MESSAGE: "Rhaym developing me", // Your bot status message
  },
